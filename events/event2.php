      ...
      <div class="section-wrapper">
        ...
        <section class="about" id="about">
          <div class="container">
            ...
            <figure class="about-banner">
              ...
              <img src="../assets/images/event2/about-img.jpg" alt="about-img" class="about-img">
            ...
            <div class="about-content">
              ...
              <h2 class="about-title">Amogus <strong>gathering</strong> </h2>

              <p class="about-text">
                A gamers gathering event for among us game! Definitely no one being sus here!
              </p>

              <p class="about-bottom-text">
                <ion-icon name="arrow-forward-circle-outline"></ion-icon>

                <span>Will learned to smell sus</span>
              </p>
            ...
            <ul class="gallery-list has-scrollbar">
              ...
              <li>
                <figure class="gallery-item">
                  <img src="../assets/images/event2/gallery-img-1.jpg" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="../assets/images/event2/gallery-img-2.jpg" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="../assets/images/event2/gallery-img-3.jpg" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="../assets/images/event2/gallery-img-4.jpg" alt="Gallery image">
                </figure>
              </li>
        ...
        <section class="tickets" id="tickets">
          <div class="container">
            ...
            $q = "SELECT EventName, bronzeSeat, silverSeat, goldSeat FROM villain WHERE EventID = 3;";
            ...
            $q = "SELECT goldprice, silverprice, bronzeprice FROM schedule WHERE EventID = 3;";
            ...
            echo '
                  <div class="card-actions">
                    <input type="hidden" name="event_name" id="event_name" value="Amogus" >
