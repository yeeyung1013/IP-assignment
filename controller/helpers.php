...
function validateEDate($startdate, $enddate) {
    $errMsgDate = array();

    try {
        if ($enddate == "" || $enddate == null) {
            throw new Exception("Please select your event end date");
        }
        ...
        if (!$endDateObj || $endDateObj->format('Y-m-d') !== $enddate) {
            throw new Exception("Please enter a valid end date in the format YYYY-MM-DD");
        }
