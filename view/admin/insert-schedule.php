...
if (isset($_POST['btnSubmit'])) {
    ...
    $errMsgDate = validateDate($startdate);
    $errMsgEDate = validateEDate($startdate, $enddate);
    $errMsgTime = validateTime($time);

    $finalErrorMessage = array_merge($errMsgSeheduleId, array_merge($errMsgEDate, array_merge($errMsgScheduleEventId, array_merge($errMsgDate,
    ...
    if (count($finalErrorMessage) > 0) {
        ...
        $schedule->setSchedule($schedule_id, $eventId, $startdate, $enddate, $time);
                        ...
                        <form class="mb-5" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-5">
                                    ...
                                    <input class="form-control" name="startdate" id="dateBox" type="date" required="true"/>
                                </div>
                                <div class="col-md-6 form-group mb-5">
                                    <label for="dateBox" class="col-form-label">End Date</label>
                                    <input class="form-control" name="enddate" id="dateBox" type="date" required="true"/>
                                </div>
                            </div>
