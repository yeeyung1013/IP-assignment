    ...
    <script>
        $(document).ready(function() {
            $('#contact').on('submit', function(event) {
                ...
                $.ajax({
                    url: 'http://localhost:7878/contact',
                    method: 'POST',
                    data: $(this).serialize(),
...
<style>
  ...
  <form id="contact" action="" method="post">
    ...
    <button type="submit" name="contactBtn"/ onclick="handleClick()">Submit</button> 
   </form>
</div> 

<script>
function handleClick() {
    if (confirm("Thank you for your response.Our admin will see your msg later")) {
