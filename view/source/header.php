...
<html lang="en">
            ...
            <div class="container">
                ...
                <nav class="navbar" data-nav>
                    ...
                    <ul class="navbar-list">
                        ...
                        <li>
                            <a href="/villain/view/Review.php" class="navbar-link">Review</a>
                        </li>
                        <li>


                            <a href="events.php" class="navbar-link">Other Events</a>
                        </li>
                        <li>
                            <a href="../controller/paymentController.php" class="navbar-link" id="cartBadge">Cart</a>
                        </li>

                        <li>
                            <?php if (isset($_SESSION['email']) && !empty($_SESSION['email'])): ?>
                                <a href="/villain/view/profile.php" class="navbar-link" id="profile">Profile</a>
                            <?php endif; ?>
                        </li>

                        <li>
                            <a href="admin/adminlogin.php" class="navbar-link">Admin</a>
                        </li>
                    </ul>
    ...
    EOT;
        ...
        <div id="login-id" class="login" style='display: none;'>
            ...
            <!-- Login Content -->
            <form class="login-content login-animate" method="POST" action="./source/actions.php">
        ...
        <div id="signup-id" class="signup" style='display: none;'>
            ...
            <form class="signup-content" method="POST" action="./source/actions.php">
                <div class="signup-container">
                    ...
                    <p>By creating an account you agree to our <a href="./source/privacy.html" style="all:revert; color:dodgerblue">Terms & Privacy</a>.</p>
        ...
        <div id="passreset-id" class="passReset" style='display: none;'>
            ...
            <form class="passReset-content passReset-animate" method="POST" action="./source/actions.php">
